            ...
            <Col className="text-col">
              ...
              <div className="about-glass">
                <div className="about-text">
                  <p>I’m a 20 year old student from Orange County, California who aspires to be an innovative creator in the field of technology.</p>
                  ...
                  <p>In my free time I enjoy journaling, hiking, playing games, and discovering new places.</p>
                </div>
              </div>
            </Col>
          </Row>
